...
- Feature 1: An input to log and update grocery purchases into a persistent dataset.

- Feature 2: A tool that analyzes stored recipes against the current inventory to show what will need to be purchased if missed ingredients. 

- Feature 3: A nutrition tracker to show daily calorie, micronutrient, and macronutrient intake. 
